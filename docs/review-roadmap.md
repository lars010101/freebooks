...
**Bill-edit form alignment ✅ (PRs #187–#188, #190).** Bill-edit aligned with journal-new visual style; shared form CSS extracted to `common.css`; header inputs aligned; CR:AP account column aligned with DR:Expense column.
